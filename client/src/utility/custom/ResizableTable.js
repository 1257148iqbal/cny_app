...
const ResizableTable = ({ className, mainClass, responsive, bordered, size, tableId, children }) => {
  ...
  return (
    <>
      <Table id={tableId} responsive={responsive} bordered={bordered} size={size} className={classnames(`${mainClass}`, `${className}`)}>
        {children}
      </Table>
    </>
  );
