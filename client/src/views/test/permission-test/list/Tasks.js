    ...
    return (
        <div className='todo-app-list'>
            <div className='app-fixed-search d-flex align-items-center'>
                ...
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime voluptas obcaecati, ipsam laboriosam consequuntur aut quisquam? Voluptatibus quis esse, sapiente delectus ab necessitatibus quidem beatae nihil distinctio eius veniam veritatis!
            </div>
        </div>
    );
};
