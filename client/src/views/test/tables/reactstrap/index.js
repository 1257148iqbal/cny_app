...
import {
  tableBasic, tableBordered,
  tableBorderless,
  tableContextual, tableDark, tableHover, tableHoverAnimation,
  tableResponsive, tableSmall, tableStriped,
  tableStripedDark, tableTheadOptions
