/*
  Title: Actions for MaterialRequirementByPoSummary
  Description: Actions for MaterialRequirementByPoSummary
...
import { FETCH_MATERIAL_REQUIREMENT_BY_PO_SUMMARY } from './actionType';

//Get Data by Query
export const fetchMaterialRequirementByPoSummary = () => async dispatch => {
  const data = {
    id: uuid(),
  ...
  dispatch( {
    type: FETCH_MATERIAL_REQUIREMENT_BY_PO_SUMMARY,
    payload: data
  } );
};
